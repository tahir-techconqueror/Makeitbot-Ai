    ...
    <div style="background: white; padding: 40px; border-radius: 0 0 10px 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
        ...
        <div style="background: #f0fdf4; border-left: 4px solid #10b981; padding: 20px; margin: 30px 0; border-radius: 4px;">
            <p style="font-size: 16px; margin: 0;">
                ...
                ✅ Weekly tips from the Markitbot agents<br>
            </p>
        </div>
...
✅ Weekly tips from the Markitbot agents

👉 START LEARNING NOW: https://markitbot.com/academy
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f9f9f9;">
    <div style="background: white; padding: 40px; border-radius: 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
        ...
        <p style="font-size: 16px; margin-bottom: 15px;">
            🤖 <strong>Ember (Budtender Agent)</strong> — Automated product search & recommendations, reducing customer decision time<br>
            📧 <strong>Drip (Marketing Agent)</strong> — Ran automated email campaigns with 22% open rates<br>
            🔍 <strong>Radar (Competitive Intel)</strong> — Monitored 12 competitors daily, identified pricing opportunities<br>
...
• $18K saved on competitive intelligence (Radar vs. manual research)

HOW THEY DID IT:
🤖 Ember (Budtender Agent) — Automated product search & recommendations
📧 Drip (Marketing Agent) — Ran automated email campaigns with 22% open rates
🔍 Radar (Competitive Intel) — Monitored 12 competitors daily, found pricing opportunities
...
👉 SEE Markitbot IN ACTION: https://markitbot.com/demo
    ...
    <div style="background: white; padding: 40px; border-radius: 0 0 10px 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
        ...
        <div style="background: #f9fafb; padding: 20px; border-left: 4px solid #10b981; margin: 20px 0; border-radius: 4px;">
            <p style="font-size: 14px; font-style: italic; margin: 0 0 10px 0;">
                "Markitbot paid for itself in the first month. The agents literally never sleep — they're handling customer questions, running campaigns, and monitoring competitors 24/7."
            </p>
        ...
        <p style="font-size: 16px; margin-top: 30px;">
            Ready to see Markitbot in action? Let's chat! 👋
        </p>
...
✨ WHAT YOU'LL GET:
• All 7 Markitbot agents (Ember, Drip, Radar, Sentinel, Pulse, Ledger, Mrs. Parker)
